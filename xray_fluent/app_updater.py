    ...
    def run(self) -> None:
        ...
        try:
            ...
            script_text = "\r\n".join([
                ...
                "    try { Start-Process -FilePath $setupPath -ArgumentList '/VERYSILENT','/SUPPRESSMSGBOXES','/NORESTART',$lumenDirArg -Wait } catch { try { Start-Process -FilePath $setupPath -Wait } catch {} }",
                "}",
